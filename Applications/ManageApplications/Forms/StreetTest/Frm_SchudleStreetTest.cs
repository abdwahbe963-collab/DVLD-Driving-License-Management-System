...
{
    public partial class Frm_SchudleStreetTest : Form
    {
        ...
        public Frm_SchudleStreetTest(int AppointmenId = -1, int LocalDrivingLicenseId = -1, bool EnabelRetakeTest = false)
        {
            InitializeComponent();
        ...
        private void Load_Application()
        {
            if (_Mode == EnMode.AddNew)
            {
                ...
                label_Fees.Text = Cls_TestTypes_BusinessLayer.Find((int)EnTestType.Street).TestTypeFees.ToString();
            ...
            //How Many Trails
            int CountTrails = 0;
            DataTable DtTrails = clsTestAppointments_BusinessLayer.GetAllTestAppointments_For_LocalLicenseApplication(_LocalDrivingLicenseId, (int)EnTestType.Street);
        ...
        private void Btn_Save_Click(object sender, EventArgs e)
        {
            ...
            _TestAppointment.TestTypeID = (int)EnTestType.Street;

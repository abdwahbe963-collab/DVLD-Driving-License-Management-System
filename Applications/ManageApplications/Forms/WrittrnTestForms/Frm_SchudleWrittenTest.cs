...
{
    public partial class Frm_SchudleWrittenTest : Form
    {
        ...
        public Frm_SchudleWrittenTest(int AppointmenId = -1, int LocalDrivingLicenseId = -1, bool EnabelRetakeTest = false)
        {
            InitializeComponent();
        ...
        private void Frm_SchudleWrittenTest_Load(object sender, EventArgs e)
        {
            Load_Application();
        }
        ...
        private void Btn_Save_Click(object sender, EventArgs e)
        {
            ...
            _TestAppointment.TestTypeID = (int)EnTestType.Written;

...
{
    public partial class Frm_TakeVisionTest : Form
    {
        ...
        public Frm_TakeVisionTest(int Appointmentid=-1, int LocalDrivingLicenseId=-1)
        {
            InitializeComponent();
        ...
        private void Frm_TakeVisionTest_Load(object sender, EventArgs e)
        {
            Load_TestInfo();
        }

    ...
    public partial class UC_DetainLicense : UserControl
    {
        ...
        private void Initilaize_Data()
        {
            ...
            if (_License != null)
            {
              ...
              decimal Fees= clsDetainedLicenses_BusinessLayer.CalculateFineFees(_License.LicenseID);
                label_FineFees.Text = Fees.ToString();
            }
        }
        ...
        private void UC_DetainLicense_Load(object sender, EventArgs e)
        {
        ...
        private void Btn_FindLicense_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (_License.IsActive)
                {
                    ...
                    {
                        MessageBox.Show("Sorry You Can't Detain Detaind or  Expired  License",
                ...
                {
                    MessageBox.Show("Sorry You Can't Detain Not Active License",
                           "Find License", MessageBoxButtons.OK
                       , MessageBoxIcon.Error);
                    Btn_Save.Enabled = false;
                    Btn_ShowLicenseInfo.Enabled = false;
        ...
        {
            _Detain_License = new clsDetainedLicenses_BusinessLayer();
            _Detain_License.LicenseID = _License.LicenseID;
            _Detain_License.DetainDate = DateTime.Now;
            _Detain_License.ReleaseDate = null;
            _Detain_License.CreatedByUserID=CurrentUser.User.UserID;
            _Detain_License.FineFees=Convert.ToDecimal( label_FineFees.Text);
            _Detain_License.ReleaseApplicationID = null;
            _Detain_License.ReleasedByUserID = null;
            _Detain_License.IsReleased = false;

            if(_Detain_License.Save())
            {
                label_Detainid.Text =_Detain_License.DetainID.ToString();
                Btn_ShowLicenseInfo.Enabled = true;
                MessageBox.Show(" License is Detaind Successfully With id= " + _Detain_License.DetainID,
            ...
            else
            {
                ...
                MessageBox.Show("Error Can't Detain License", "System Error", MessageBoxButtons.OK
                   , MessageBoxIcon.Error);
            }
        }
